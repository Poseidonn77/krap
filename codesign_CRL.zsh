...
# Array of CRL URLs
CRL_URLS=("http://crl.usertrust.com/USERTrustRSACertificationAuthority.crl"
          ...
          "http://crl.camerfirma.com/chambersofcommerceroot-2016.crl"
          ...
          "http://crl.trustcor.ca/sub/iv-codesign.crl"
          "http://crl.trustcor.ca/sub/ov-codesign.crl"
